...
p(html::js('function newUpdate(a){document.getElementById("updates").innerHTML = "<#Latest Stable#>: <a href=\"http://code.google.com/p/samstyle-php-framework/downloads/list\">"+a.stable+"</a><br/><#Current Development#>: "+a.dev;}window.onload = function(){getVersions([],\'newUpdate\');};'));
